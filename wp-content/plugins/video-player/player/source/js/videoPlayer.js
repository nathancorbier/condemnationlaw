...
//    tag2.src = "http://a.vimeocdn.com/js/froogaloop2.min.js"; // Take the API address.
    ...
    this.loadFontAwesome("css/font-awesome.css");
	this.loadCSSMain("css/videoPlayerMain.css");

	if(this.options.skinPlayer == "Default"){
		this.loadCSSTheme("css/videoPlayer.theme1.css");
	}
	if(this.options.skinPlaylist == "Default"){
		this.loadCSSThemePlaylist("css/videoPlayer.theme1_Playlist.css");
	}
	if(this.options.skinPlayer == "Classic"){
		this.loadCSSTheme("css/videoPlayer.theme2.css");
	}
	if(this.options.skinPlaylist == "Classic"){
		this.loadCSSThemePlaylist("css/videoPlayer.theme2_Playlist.css");
	}
		if(this.options.skinPlayer == "Minimal"){
		this.loadCSSTheme("css/videoPlayer.theme3.css");
	}
	if(this.options.skinPlaylist == "Minimal"){
		this.loadCSSThemePlaylist("css/videoPlayer.theme3_Playlist.css");
	}
	if(this.options.skinPlayer == "Transparent"){
		this.loadCSSTheme("css/videoPlayer.theme4.css");
	}
	if(this.options.skinPlaylist == "Transparent"){
		this.loadCSSThemePlaylist("css/videoPlayer.theme4_Playlist.css");
	}
	if(this.options.skinPlayer == "Silver"){
		this.loadCSSTheme("css/videoPlayer.theme5.css");
	}
	if(this.options.skinPlaylist == "Silver"){
		this.loadCSSThemePlaylist("css/videoPlayer.theme5_Playlist.css");
	}
...
//                console.log(self.video.buffered.length-1)
        ...
        this.ontimeupdate($.proxy(function(){
            if(pw){
                if(self.options.videos[0].title!="Big Buck Bunny Trailer" && self.options.videos[0].title!="Sintel Trailer" && self.options.videos[0].title!="Oceans" && self.options.videos[0].title!="Photo Models" && self.options.videos[0].title!="Corporate Business"){
