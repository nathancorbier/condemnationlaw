(function(a) {
	...
	a.fn.slider_start = function() {
		a(this).data("tcl").start()
	};
	a.fn.slider_stop = function() {
		a(this).data("tcl").stop()
	};
	a.fn.slider_move = function(c) {
		a(this).data("tcl").move(c - 1, true)
	};
	function b(q, e) {
		var i = this, h = a(".viewport:first", q), g = a(".overview:first", q), k = g
				.children(), f = a(".next:first", q), d = a(".prev:first", q), l = a(
				".pager:first", q), w = 0, u = 0, p = 0, j = undefined, o = false, n = true, s = e.axis === "x";
		function m() {
			if (e.controls) {
		...
		function c() {
			...
			var x = Math
					.ceil(((s ? h.outerWidth() : h.outerHeight()) / (w * e.display)) - 1);
