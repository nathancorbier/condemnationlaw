  ...
  <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>" onsubmit="return hdwplayer_validate();">
    ...
    <table cellpadding="0" cellspacing="10">
      ...
      <tr>
        ...
        <td><input type="text" id="columns" name="columns" value="<?php echo $data->columns; ?>" size="50" /></td>
      </tr>
      <tr>
        <td width="30%"><?php _e("Display Limit" ); ?></td>
        <td><input type="text" id="limit" name="limit" value="<?php echo $data->limit; ?>" size="50" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" id="space" name="space" value="<?php echo $data->space; ?>" size="50" /></td>
      </tr>
    </table>
    <br />
