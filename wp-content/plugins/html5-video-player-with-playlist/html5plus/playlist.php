...
<table class="wp-list-table widefat fixed" cellspacing="0" style="margin-top:20px;">
	...
	<tr>
        ...
        <th scope="col" width="5%" ><a href="#">Size</a></th>
        <th scope="col" width="20%"><a href="#">Description</a></th>
        <th scope="col" width="20%"><a href="#">Shortcode</a></th>
        <th scope="col" width="10%"><a href="#">XML</a></th>
        <th scope="col" width="10%"><a href="#">Edit</a></th>	
        <th scope="col" width="10%"><a href="#">Delete</a></th>		
     </tr>
    ...
    <tr>
        ...
        <?php /*?><td><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=html5video_playlist&action=preview&id=<?php echo $result->id; ?>"><?php echo $result->title; ?></a></td><?php */?>
        
        <td><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=html5video_add_playlist&action=update&id=<?php echo $result['id']; ?>"><?php echo $result['title']; ?></a></td>
        ...
        <td width="10%"><a href="<?php echo plugin_dir_url(__FILE__)."../xml/".$result['xml']; ?>" target="_blank"><?php echo $result['xml']; ?></a></td>
    ...
    <td class="posts column-posts num" colspan="7"><a href="admin.php?page=html5video_add_playlist">Please add playlist</a></td>
