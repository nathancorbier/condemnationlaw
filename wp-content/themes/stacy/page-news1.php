                ...
                <div class="body-drop">
                    <div class="col-sm-8">
                        <div class="body-low-left">
                            ...
                            <?php
                                query_posts("post_type=news&showposts=-1&post_status=publish")
                            ?>
                            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                                      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                        <h2 class="title"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>

                                          <div class="fleft" style="float:none"><time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('F j, Y'); ?> at <?php the_time() ?></time> | 
